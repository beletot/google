...
<body>
  ...
  with the user account <b>admin@epfc.eu</b> is trying to log into 
  ...
  <b>http://mail.google.com/a/epfc.eu</b>.</p>
  </div>
  ...
  <table width="100%" height="100%">
    <tr>
      <td>
        <iframe name="service_provider" src="./service_provider.php"
          width="100%" height="100%" frameborder="1"></iframe>
      </td>
      <td>
        <iframe name="identity_provider" src="./process_response.php"
          width="100%" height="100%" frameborder="1"></iframe>
      </td>
    </tr>
  </table>
