...
<body>
  ...
  <ul>
	...
	https://www.google.com/a/epfc.eu/acs
	</div>
    </li>
  </ul>
  </p>

  <form name="ServiceProviderForm" action="./create_request.php" method="post">
  <input type="hidden" name="action" value="Generate SAML Request">
  <input type="hidden" name="returnPage" value="service_provider.php">
  <p><center><input type="submit" value="Generate SAML Request"></center>
  </form>
  <?php
    if ($error != null) {
  ?>
